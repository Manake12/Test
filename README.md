...
spawn(function()
	while wait() do
		...
		pcall(function()
			if _G.Auto_Farm_Level and _G.Auto_Farm_Quest == true then
			...
			elseif _G.Auto_Farm_Quest == false and _G.Auto_Farm_Level then
				if game:GetService("Workspace").Enemies:FindFirstChild(QuestCheck()[3]) then
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == QuestCheck()[3] then
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat wait()
									...
									v.HumanoidRootPart.Transparency = 1
									getgenv().ToTarget(v.HumanoidRootPart.CFrame * MethodFarm)
								until not _G.Auto_Farm_Level or not v.Parent or v.Humanoid.Health <= 0 or not v:FindFirstChild("HumanoidRootPart")
							end
						end
					end
				else
